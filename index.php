            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="#" class="site_title" onclick="load_page('main.php');return false;"><i class="fa fa-paper-plane"></i> <span>TechnoVision 3D</span></a>
                    </div>
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-folder-open"></i>Browse files<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li onclick="load_page('upload.php');return false;"><a href="#"><span class="fa fa-upload"></span>Upload New</a>
                                        </li>
                                        <li onclick="load_page('usb.php');return false;"><a href="#"><span class="fa fa-hdd-o"></span>USB</a>
                                        </li>
                                    </ul>
                                </li>
